...
@Entity({ name: 'application_employer' })
export class ApplicationEmployer {
  ...
  @ManyToOne(() => Application, (application) => application.employers, {
        onDelete: 'RESTRICT',
        onUpdate: 'RESTRICT',
    })
  ...
  @ManyToOne(() => GeoCommune, (commune) => commune.employers, {
        onDelete: 'RESTRICT',
        onUpdate: 'RESTRICT',
    })
