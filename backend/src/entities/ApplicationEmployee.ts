...
@Entity({ name: 'application_employee' })
export class ApplicationEmployee {
  ...
  @ManyToOne(() => Application, (application) => application.employees, {
        onDelete: 'RESTRICT',
        onUpdate: 'RESTRICT',
    })
  ...
  @ManyToOne(() => GeoCommune, (commune) => commune.employees, {
        onDelete: 'RESTRICT',
        onUpdate: 'RESTRICT',
    })
